...
// FIX: Declare the custom element locally as a component to bypass TypeScript's
// IntrinsicElements check without polluting the global namespace.
const ModelViewer = 'model-viewer' as unknown as React.ComponentType<any>;
